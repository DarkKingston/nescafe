(function ($, Drupal) {
  Drupal.behaviors.lnNotificationUsersettingsBlock = {
      ...
      $('.block-notification-system-dispatch-usersettings').once('attachWebPush').each(function () {
        ...
        $checkbox.on('change', function () {
          ...
          if (value) {
            ...
            Drupal.lnNotification.subscribe();
          }
          else {
        ...
        $button.click(function (e) {
          ...
          if (Drupal.lnNotification.state === 'enabled') {
            Drupal.lnNotification.unsubscribe();
          }

          if (Drupal.lnNotification.state === 'disabled') {
            Drupal.lnNotification.subscribe();
          }
        });
        ...
        Drupal.lnNotification.on('stateChange', function (newState) {
          ...
          switch (newState) {
            ...
            case 'enabled':
              ...
              if (!Drupal.lnNotification.unsubscribeSupported) {
                $button.hide();
              }
              break;
        ...
        // things.
        Drupal.lnNotification.initialize()
          .then(result => {
