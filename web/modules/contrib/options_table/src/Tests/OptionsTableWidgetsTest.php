...
class OptionsTableWidgetsTest extends FieldTestBase {
  ...
  public function testRadioButtons() {
    ...
    $field->save();
    $this->container->get('entity_display.repository')->getFormDisplay('entity_test', 'entity_test', 'default')
  ...
  public function testCaption() {
    ...
    // Display form: caption should be visible.
    $this->drupalGet('entity_test/add');
    $this->assertSession->pageTextContainsOnce('Caption test');
  }
