...
(function ($, Drupal, drupalSettings) {
  ...
  Drupal.behaviors.ln_datalayer_global_events = {
    attach: function (context, settings) {
      //CTA link event
      $('.field--name-field-c-link a').once('ln_datalayer_cta_click').click(function(ev){
        let $link = $(this);
      ...
      //Outbound links
      $("a[target='_blank']").once('ln_datalayer_outbound_link').click(function(ev){
        let $link = $(this);
      ...
      $(".form-managed-file").once('input').change(function(ev){
        window.dataLayer = window.dataLayer || [];
        window.dataLayer.push({
