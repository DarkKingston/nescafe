...
class ExternalHreflang extends LinkRelBase {
  ...
  public function description() {
    return $this->t('Enter one link per hreflang, each separated by pipe (|) for code and url. Example: en-us|https://us.site.com/en[current-page:url:relative:en] <a href = "https://martinkura.com/list-hreflang-country-language-codes-attributes/" target = "blank">Hreflang Reference</a>');
  }
