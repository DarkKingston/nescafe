 ...
 *
 * @FieldFormatter(
 *   id = "srh_entity_reference_grid",
 *   label = @Translation("SRH Entity Reference Grid"),
 ...
 * )
 */
class SRHEntityReferenceGrid extends EntityReferenceEntityFormatter implements ContainerFactoryPluginInterface {
