...
class Notification extends ContentEntityBase implements NotificationInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['forced'] = BaseFieldDefinition::create('boolean')
      ->setLabel(t('Forced'))
      ->setDescription(t('Indicates if the notification is forced and will bypass the user settings.'))
      ->setTranslatable(FALSE)
      ->setDefaultValue(FALSE)
      ->setRequired(FALSE)
      ->setDisplayOptions('form', [
