 ...
 *
 * @FieldFormatter(
 *   id = "lightnest_media_oembed_lazyload",
 *   label = @Translation("Oembed Video Lazyload"),
 *   field_types = {
 *     "link",
 *     "string",
 *     "string_long",
 ...
 * )
 */
class LightnestMediaLazyLoad extends FormatterBase implements ContainerFactoryPluginInterface {
   ...
   */
  public function __construct($plugin_id, $plugin_definition, FieldDefinitionInterface $field_definition, array $settings, $label, $view_mode, array $third_party_settings, ResourceFetcherInterface $resource_fetcher, UrlResolverInterface $url_resolver, LoggerChannelFactoryInterface $logger_factory, ConfigFactoryInterface $config_factory, IFrameUrlHelper $iframe_url_helper, RendererInterface $renderer, FormatterInterface $thumbnail_formatter, FormatterInterface $video_formatter) {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($items as $delta => $item) {
      ...
      $itemThumb[] = [
        ...
        '#tag' => 'button',
        '#attributes' => [
          'class' => ['video-oembed-media-lazy-play'],
        ],
      ];
      ...
      $thumbVideoPlayWrapper = [
        '#type' => 'container',
        '#attributes' => [
          'class' => ['video-oembed-media-lazy-play-wrapper'],
        ],
        'children' => $itemThumb,
      ];
      $element[$delta] = [
        '#type' => 'container',
        '#attributes' => [
          'data-video-oembed-media-lazy' => (string) $this->renderer->render($videos[$delta]),
          'class' => ['video-oembed-media-lazy'],
        ],
        '#attached' => [
          'library' => [
            'ln_c_video_embed/lazy-load',
          ],
        ],
