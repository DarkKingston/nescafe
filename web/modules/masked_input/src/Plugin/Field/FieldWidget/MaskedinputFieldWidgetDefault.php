...
public function settingsForm(array $form, FormStateInterface $form_state) {
  ...
  $admin_link = Link::fromTextAndUrl($this->t('admin/config/user-interface/masked_input'), $url)->toString();
...
/**
  ...
  */
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
   ...
   if(isset($element['#field_parents']) && !empty($element['#field_parents']) ){
     $element_id = strtolower(str_replace(array(' ','(',')'),'-',$element['#title'])) . '-' . $element['#field_parents'][1];
    }else{
